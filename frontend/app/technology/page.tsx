          ...
          <section className="py-16 border-b border-[#eef0f3]">
            <Reveal>
              ...
              <div className="bg-white border border-[#dee1e6] rounded-xl overflow-hidden">
                <div className="grid grid-cols-[100px_1fr] sm:grid-cols-[140px_1fr_140px] gap-4 px-5 py-3 bg-[#f7f7f7] border-b border-[#dee1e6] text-[11px] uppercase tracking-[0.05em] text-[#7c828a] font-semibold">
                  <span>Source</span>
                ...
                {[
                  ...
                  <div
                    key={name}
                    className={`grid grid-cols-[100px_1fr] sm:grid-cols-[140px_1fr_140px] gap-4 px-5 py-4 items-start ${i < arr.length - 1 ? 'border-b border-[#eef0f3]' : ''}`}
                  >
